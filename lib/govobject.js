...
GovObjectController.prototype.submit = function (req, res) {
  ...
  this.node.services.raidencashd.govObjectSubmit(parentHash, revision, time, dataHex, feeTxId, function(err, result) {
...
GovObjectController.prototype.govObjectList = function(options, callback) {
    this.node.services.raidencashd.govObjectList(options, function(err, result) {
        if (err) {
            return callback(err);
        }
...
GovObjectController.prototype.getHash = function(hash, callback) {
    ...
    this.node.services.raidencashd.govObjectHash(hash, function(err, result) {
        if (err) {
            return callback(err);
        }
...
GovObjectController.prototype.govObjectCheck = function(req, res) {
  ...
  this.node.services.raidencashd.govObjectCheck(hexdata, function(err, result) {
    if (err) {
      return self.common.handleErrors(err, res);
    }
    res.jsonp(result);
...
GovObjectController.prototype.getInfo = function (req, res) {
  var self = this;
  this.node.services.raidencashd.govObjectInfo(function (err, result) {
    if(err) { return self.common.handleErrors(err, res);}
    res.jsonp(result);
  })
}
...
GovObjectController.prototype.getCount = function (req, res) {
  var self = this;
  this.node.services.raidencashd.govCount(function (err, result) {
    if(err) { return self.common.handleErrors(err, res);}
    res.jsonp(result);
  })
}
...
GovObjectController.prototype.govObjectVotes = function (req, res) {
  ...
  this.node.services.raidencashd.getVotes(govHash, function (err, result) {
    if(err) { return self.common.handleErrors(err, res);}
    res.jsonp(result);
  })
}
...
GovObjectController.prototype.govObjectCurrentVotes = function (req, res) {
  ...
  this.node.services.raidencashd.getCurrentVotes(govHash, function (err, result) {
    if(err) { return self.common.handleErrors(err, res);}
    res.jsonp(result);
  })
}
...
GovObjectController.prototype.govObjectDeserialize = function (req, res) {
  ...
  this.node.services.raidencashd.govObjectDeserialize(hexdata, function (err, result) {
    if(err) { return self.common.handleErrors(err, res);}
    res.jsonp(result);
  })
}
